        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-blue-50 rounded-lg border border-blue-100/60">
          ...
          <div className="space-y-2">
            {displayShortcuts.map((shortcut) => (
              ...
              >
                ...
                <kbd className="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-mono font-medium text-slate-600 bg-slate-100 border border-slate-200 rounded-md shadow-sm">
          ...
          <div className="mt-5 pt-4 border-t border-slate-100">
            <p className="text-xs text-slate-400 text-center">
              Press <kbd className="px-1.5 py-0.5 text-xs bg-slate-100 rounded border border-slate-200">?</kbd> or{' '}
              <kbd className="px-1.5 py-0.5 text-xs bg-slate-100 rounded border border-slate-200">Ctrl+K</kbd> to toggle this dialog
            </p>
          </div>
        </div>
      </div>
